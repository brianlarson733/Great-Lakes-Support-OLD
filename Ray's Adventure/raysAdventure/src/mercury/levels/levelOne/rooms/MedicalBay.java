...
public class MedicalBay extends BasicRoom {
    ...
    public MedicalBay() {
        super(new ArrayList<BasicItem>(), new ArrayList<BasicItem>(), new ArrayList<BasicBeing>(), new ArrayList<BasicRoom>(),
                "This stainless steel room sparkles and smells of iodine. In the center of the room there's an elevated slab as long as a body. Cupboards line the walls.", "Medical Bay");
    }
}